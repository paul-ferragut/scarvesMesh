...
class ofxSimpleSlider {
	...
	public:
		...
		void	mouseMoved(int xm, int ym);
		void	mouseDragged(int xm, int ym);
		void	mousePressed(int xm, int ym);
		void	mouseReleased(int xm, int ym);
		...
		void	updateLayout(ofRectangle rect);
